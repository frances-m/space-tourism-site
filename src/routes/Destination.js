                    ...
                    <section className="destination__content">
                        ...
                        <div className="destination__text-container">
                            <nav className="destination__nav">
                                <ul>
                                    <li><button className={destination.name === "moon" ? "nav-btn active-tab" : "nav-btn"} value="moon" onClick={handleDestinationClick}>Moon</button></li>
                                    <li><button className={destination.name === "mars" ? "nav-btn active-tab" : "nav-btn"} value="mars" onClick={handleDestinationClick}>Mars</button></li>
                                    <li><button className={destination.name === "europa" ? "nav-btn active-tab" : "nav-btn"} value="europa" onClick={handleDestinationClick}>Europa</button></li>
                                    <li><button className={destination.name === "titan" ? "nav-btn active-tab" : "nav-btn"} value="titan" onClick={handleDestinationClick}>Titan</button></li>
                                </ul>
                            </nav>
